"""
Django settings for tsunami_46255 project.
...
ROOT_URLCONF = 'tsunami_46255.urls'
...
WSGI_APPLICATION = 'tsunami_46255.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tsunami_46255 API",
    "DESCRIPTION": "API documentation for tsunami_46255 App",
    "VERSION": "v1",
}
